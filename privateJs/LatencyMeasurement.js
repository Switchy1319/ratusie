!function(r) {
    ...
    11: function(t, e, r) {
        ...
        function p(t, e, r, n, o, i, s) {
            ...
            if (s && (a.via = s.via),
            !t || !window.performance || !window.performance.getEntriesByName)
                return a;
            var u = window.performance.getEntriesByName(t);
            if (0 == u.length && 0 == (u = window.performance.getEntriesByName(t + "/")).length)
                return a;
            var c = u[u.length - 1];
            return "decodedBodySize"in c && 0 < c.decodedBodySize && (a.size = c.decodedBodySize),
            c.duration ? a.d = c.duration : c.startTime && c.responseEnd && (a.d = c.responseEnd - c.startTime),
            c.requestStart && (a.dns = c.domainLookupEnd - c.domainLookupStart,
            a.rtt = c.responseStart - c.requestStart,
            a.ttfb = c.responseStart - c.startTime,
            a.tcp = c.connectEnd - c.connectStart,
            0 === c.secureConnectionStart ? a.tls = 0 : void 0 !== c.secureConnectionStart && (a.tls = c.connectEnd - c.secureConnectionStart,
            a.tcp -= a.tls)),
            a
        }
        function f(t) {
        ...
        var n = (o.prototype.get = function(n, t, o, e) {
            ...
            if ("withCredentials"in i) {
                e.withCookies && (i.withCredentials = !0),
                t && (i.timeout = t);
                var s = c()
                  , a = 0;
                i.open("GET", n, !0),
        ...
        o.prototype.getData = function(t, e, r, n) {
            ...
            "withCredentials"in o ? (n.withCookies && (o.withCredentials = !0),
            e && (o.timeout = e),
            c(),
            o.open("GET", t, !0),
    ...
    17: function(t, e, r) {
        ...
        var o = (i.prototype.getRecipe = function(t, u) {
            var e = this.url
              , r = -1 === e.indexOf("?") ? "?" : "&";
            e = e + r + "iteration=" + t,
            i.requester.getData(e, 0, function(t, e, r) {
                if (200 == t && null != r)
                    try {
                        var n = JSON.parse(r)
                          , o = "FTLTester: param";
                        if (!c(n))
                            throw new Error(o + ": not an object");
                        if (!p(n.next))
                            throw new Error(o + ".next: not an integer");
                        if (!p(n.pulses))
                            throw new Error(o + ".pulses: not an integer");
                        if (!p(n.pulse_delay))
                            throw new Error(o + ".pulse_delay: not an integer");
                        if (!p(n.pulse_timeout))
                            throw new Error(o + ".pulse_timeout: not an integer");
                        if (!f(n.name))
                            throw new Error(o + ".name: not a string");
                        if (!c(n.ctx))
                            throw new Error(o + ".ctx: not an object");
                        if (!function(t) {
                        ...
                        for (var i = 0, s = n.targets.length; i < s; i++) {
                            var a = n.targets[i];
                            if (!c(a))
                                throw new Error(o + ".targets[" + i + "]: not an object");
                            if (!f(a.name))
                                throw new Error(o + ".targets[" + i + "].name: not a string");
                            if (!f(a.target))
    ...
    26: function(t, e, r) {
        ...
        var i = (s.prototype.getTester = function(t, e) {
            if ("http_get" == e.type)
                return new n(t,e.pulse_timeout);
        ...
        u.prototype.stop = function() {
            this.nextJob && (this.nextJob.cancel(),
            this.nextJob = void 0)
        }
        ,
        ...
        u.prototype.forEachTarget = function(t, e) {
            for (var r = 0, n = t.targets.length; r < n; r++)
                e.bind(this)(t.targets[r])
        }
        ,
        ...
        u.prototype.handleResult = function(t, e) {
            ...
            this.nextJob && (0 < t.next ? this.nextJob = this.scheduleAfter(t.next, this.run.bind(this)) : (this.completed = !0,
            this.stop()))
        }
        ,
        u);
        ...
        var f, l, h = r(11), d = ((f = function(t, e) {
